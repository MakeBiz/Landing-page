...
def org_full(lang):
    return {'@type': 'Organization', '@id': ORG, 'name': 'MakeBiz Group', 'alternateName': ['MakeBiz', 'MakeBiz Technologies'],
      ...
      'address': {'@type': 'PostalAddress', 'streetAddress': 'Ajman NuVentures Centre', 'addressLocality': 'Ajman', 'addressRegion': 'Ajman', 'addressCountry': 'AE'},
      'areaServed': [{'@type': 'City', 'name': 'Dubai'}, {'@type': 'Country', 'name': 'United Arab Emirates'}, {'@type': 'Country', 'name': 'Russia'}],
      'knowsLanguage': ['ru', 'en'],
      'knowsAbout': ['Bitrix24', 'CRM implementation', 'AI agents', 'Business process automation', 'Speech analytics', 'Call analytics', 'Document AI', 'BI analytics', 'IT infrastructure'],
